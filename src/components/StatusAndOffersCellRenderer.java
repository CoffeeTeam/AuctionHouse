...
public class StatusAndOffersCellRenderer extends DefaultTableCellRenderer{
	private static final long serialVersionUID = 1L;
	private GUI instanceGUI;

	public StatusAndOffersCellRenderer(GUI instanceGUI) {
		super();
	...
	public Component getTableCellRendererComponent(JTable table, Object value, 
		...
		HashMap<String, String> matches = 
				instanceGUI.getUser().getServiceProviders(serviceName);
